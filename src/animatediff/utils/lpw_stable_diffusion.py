...
def get_unweighted_text_embeddings(
    ...
    if max_embeddings_multiples > 1:
        ...
        for i in range(max_embeddings_multiples):
            ...
            if isinstance(pipe.text_encoder, CLIPSkipTextModel):
                text_embedding = pipe.text_encoder(text_input_chunk, clip_skip=clip_skip)[0]
            else:
        ...
        if isinstance(pipe.text_encoder, CLIPSkipTextModel):
            text_embeddings = pipe.text_encoder(text_input, clip_skip=clip_skip)[0]
        else:
